...
import { Users, FileText, Ghost, Phone, MessageCircle, Settings, LogOut, Search, Upload, BarChart3 } from 'lucide-react';
...
// import timelineAnim from '../assets/timeline.json';

const sidebarLinks = [
  { icon: <Search />, label: 'Dashboard', route: '/dashboard/user' },
  { icon: <Users />, label: 'Find a Lawyer', route: '/dashboard/user/find-lawyer' },
  { icon: <FileText />, label: 'My Cases', route: '/dashboard/user/cases' },
  { icon: <Upload />, label: 'Document Summarizer', route: '/dashboard/user/summarizer' },
  { icon: <Ghost />, label: 'Ghost Argument Detector', route: '/dashboard/user/ghost-detector' },
  { icon: <Phone />, label: 'IVR Callback', route: '/dashboard/user/ivr' },
  { icon: <MessageCircle />, label: 'Chat with Vaanee', route: '/dashboard/user/chat' },
...
const quickActions = [
  {
    ...
    label: 'Upload & Summarize Document',
    // lottie: uploadAnim,
  ...
  },
  {
    ...
    label: 'Talk to Vaanee (AI Chatbot)',
    // lottie: chatbotAnim,
    ...
    <div className="min-h-screen flex bg-[#0e0e0e] font-poppins">
      ...
      <main className="flex-1 flex flex-col items-center px-2 md:px-8 py-8 bg-gradient-to-br from-[#0e0e0e] to-[#101F2F] min-h-screen relative overflow-x-hidden">
        ...
        >
          ...
          >
            <defs>
              <radialGradient id="userDashBlob" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
        ...
        <HeroSection
          name={name}
          subtitle="Here are your quick actions & legal journey insights."
