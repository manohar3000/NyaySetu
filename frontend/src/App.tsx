...
const App = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Ghost Argument Detector",
      description: "Advanced AI technology to detect legal flaws and strengthen your arguments."
    },
    {
      icon: <FileText className="w-8 h-8" />,
      title: "Document Summarizer",
      description: "Instantly summarize complex legal documents and extract key insights."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      role: "Senior Lawyer",
      content: "NyaySetu has revolutionized how I research legal precedents. Vaanee understands context like a human colleague.",
      rating: 5
    },
    {
      name: "Rahul Sharma",
      role: "Small Business Owner",
      content: "I just spoke to Vaanee about my contract issues. Got clear answers in minutes, not hours. Amazing!",
      rating: 5
    },
    {
      name: "Dr. Priya Gupta",
      role: "Legal Researcher",
      content: "Vaanee's voice interface makes legal research feel natural. It's like having a conversation with a legal expert.",
      rating: 5
    }
  ];
              ...
              <div className="container mx-auto px-4">
                ...
                >
                  ...
                  <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                    Ask questions, upload documents, or just talk — we'll help you understand the law, one voice at a time.
                  </p>
            ...
            <section className="py-20 bg-gradient-to-b from-black to-gray-900">
              <div className="container mx-auto px-4">
                ...
                >
                  ...
                  <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                    See what our users are saying about NyaySetu
                  </p>
                </motion.div>
